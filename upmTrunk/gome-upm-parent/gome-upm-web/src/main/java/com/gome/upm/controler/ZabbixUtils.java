...
public class ZabbixUtils {
	 ...
	 * @throws Exception
	 */
	public static JSONArray getDatas(String hostid, String item, long time_from, long time_till)
			throws Exception {
		setAuth();
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("output", "extend");
		...
		params.put("time_from", time_from / 1000);
		params.put("time_till", time_till / 1000);
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("jsonrpc", "2.0");
	 ...
	 * @throws Exception
	 */
	public static JSONArray getDataByItemId(String hostid, String itemId, long time_from, long time_till)
			throws Exception {
		setAuth();
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("output", "extend");
	 ...
	 * @throws Exception
	 */
	public static JSONArray getDataByItemId2(String hostid, String itemId, long time_from, long time_till)
			throws Exception {
		setAuth();
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("output", "extend");
	 ...
	 * @throws Exception
	 */
	public static JSONArray getTriggerByItemId(String itemids) throws Exception {
		setAuth();
		Map<String, Object> map = new HashMap<String, Object>();
		Map<String, Object> params = new HashMap<String, Object>();
		Map<String, Object> filter = new HashMap<String, Object>();
		filter.put("hostid ", "12224");
		params.put("output", "extend");
		params.put("filter", filter);
	 ...
	 * @throws Exception
	 */
	public static int getTriggerCount(String itemids) throws Exception {
		setAuth();
		Map<String, Object> map = new HashMap<String, Object>();
		Map<String, Object> params = new HashMap<String, Object>();
		Map<String, Object> filter = new HashMap<String, Object>();
	...
	public static void main(String[] args) throws Exception {
		setAuth();
//		List<Map<String,Object>> hostList = getHostList("");
//		System.out.println(new Date());
//		for (int i = 0; i < hostList.size(); i++) {
//			//内存使用率>90%
//			String ip = getHostInterface(hostList.get(i).get("hostid").toString());
//			JSONObject objectMemeor = getItems(hostList.get(i).get("hostid").toString(),"agent.ping");
//			if(objectMemeor!=null){
//				String f = (String) objectMemeor.get("lastvalue");
//				System.out.println("ip+lastvalue===="+ip+"-"+f);
//			}
//		}
		String str = "237736";
		JSONArray triggerByItemId = getTriggerByItemId(str);
		System.out.println(triggerByItemId);
	}
}
