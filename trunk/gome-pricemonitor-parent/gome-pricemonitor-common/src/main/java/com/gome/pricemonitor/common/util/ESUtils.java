...
//	public static final String CLUSTER_NAME = "elasticsearch"; 
	public static final String CLUSTER_NAME = "logger_elasticsearch";
	
	/** 节点地址 */
//	private static final String HOSTS = "127.0.0.1";
	private static final String HOSTS = "10.58.50.66,10.58.50.67";
	...
	public static Client getClient() {
		...
		return transportClient.addTransportAddress(new InetSocketTransportAddress(HOSTS, PORT));
	}
