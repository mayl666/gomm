package com.gome.pricemonitor.common.des;
...
public class  MobileMD5{
    ...
    public static String encrypt(String body, String encode) {
        MobileMD5 md5 = new MobileMD5();
        String s = null;
        byte buf[] = null;
        try {
            buf = body.getBytes(encode);
            s = md5.getMD5ofString(buf, buf.length);
